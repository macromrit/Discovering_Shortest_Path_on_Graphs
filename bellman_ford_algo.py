...
#         self.name = name
#         #list gotta store edges connected to it
#         self.adjacency_list = list()
#         self.predecessor = None
#         self.min_distance = float('inf')
    
# class BellmanFordAlgorith:
...
#             self.start_vertex = start_vertex
#             self.has_cycle = False #has negative cycle or not by default its False
        
#         def find_shortest_path(self):
            
#             self.start_vertex.min_distance = 0
            
#             #iterate through (V-1) Times as per algo
#             for _ in range(len(self.vertex_list)-1):
                
#                 # in every iteration we consider all the edges
#                 #final running time O(V*E)
#                 for edge in self.edge_list:
#                     #we have to calculate wheter are there shorter paths 
#                     u = edge.start_vertex
...
#                 print("shortest path exists with value : {}". format(vertex.min_distance))
#                 node = vertex
...
#     edge12 = Edge(-12, node7, node3)
    
    
#     #handle the adjacency list
...
#     vertices = (node1, node2, node3, node5, node5, node6, node7)
#     edges = (edge1, edge2, edge3, edge4, edge5, edge6, edge7, edge8, edge9, edge10, edge11, edge12)
    
#     algorithm = BellmanFordAlgorith(vertices, edges, node1)
